...
def main(image_finetune: bool,
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    if not image_finetune: # aniation
        pretrained_model_path = "pretrained/models/StableDiffusion/stable-diffusion-v1-5"
    ...
    for name, param in unet.named_parameters():
        for trainable_module_name in trainable_modules:
            if trainable_module_name in name:
                ...
                break # nothing applyes
    # ----------------------------------------------------------------------------------------------------
    # which module is training ... ?
    # lambda function : make unet parameter trainable
    # filter funtion : filter the parameters that require grad
    original_params = list(unet.parameters())
    print(f'original_params = {len(original_params)}')

    trainable_params = list(filter(lambda p: p.requires_grad, unet.parameters()))
    print(f'trainable_params: {len(trainable_params)}')
    ...
    """ checking of dataset is important """
    # webVid10M Data
